...
const Hero = () => {
  return (
    <section
      id="hero"
      className="relative mx-auto w-full max-w-6xl py-20 px-4 sm:px-6 lg:px-8"
    >
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
        {/* Left side - Text content */}
        <div className="lg:w-1/2 text-center lg:text-right">
          <div className="flex flex-col items-center lg:items-end gap-3 text-neutral-200">
            <span className="text-sm uppercase tracking-[0.4em] text-neutral-400">Hello There!</span>
          ...
          <div className="pt-8 w-full">
            ...
            <div className="flex justify-center lg:justify-end space-x-4 flex-wrap gap-4">
              ...
              <a href="https://www.instagram.com/_sarguru._/" target="_blank" rel="noopener noreferrer" className="p-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl text-gray-300 hover:text-white hover:bg-white/10 transition-all duration-300 flex-shrink-0">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-wrap items-center justify-center lg:justify-end gap-4 mt-8">
            <a
              ...
              className="group flex items-center gap-2 rounded-full bg-neutral-900 px-6 py-3 text-base font-semibold text-white shadow-[0_15px_30px_rgba(0,0,0,0.35)] transition hover:bg-neutral-800"
            >
              Resume
