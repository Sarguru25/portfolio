...
const Contact = () => {
  ...
  return (
    <div className="main-card" id="contact">
      {/* Content wrapper with pointer-events management */}
      <div className="relative pointer-events-none">
        <div className="pointer-events-auto w-full max-w-none mx-auto">
          <div className="text-center mb-8">
              <h1 className="main-h1">To Contact!</h1>

                <h2 className="main-h2">
                  Let’s Talk for   <span className='main-h2-span'>Your Next Projects!</span>
                </h2>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 w-full">
            ...
            <div className="w-full">
              <div className="grid gap-4 w-full">
                <div className="cursor-target flex items-start space-x-4 p-4 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300 w-full">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <a href="mailto:sargurudurai25@gmail.com" className="cursor-target text-gray-300 hover:text-blue-400 transition-colors text-base break-words">
                ...
                <div className="cursor-target flex items-start space-x-4 p-4 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300 w-full">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <a href="tel:+917010126911" className="cursor-target text-gray-300 hover:text-green-400 transition-colors text-base">
                      +91 7010126911
                    </a>
                  </div>
                </div>
              ...
              <div className="pt-8 w-full">
                ...
                <div className="flex space-x-4 flex-wrap gap-4">
                  <a href="https://github.com/Sarguru25" target="_blank" rel="noopener noreferrer" className="cursor-target p-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl text-gray-300 hover:text-white hover:bg-white/10 transition-all duration-300 flex-shrink-0">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="https://linkedin.com/in/sarguru25" target="_blank" rel="noopener noreferrer" className="cursor-target p-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl text-gray-300 hover:text-white hover:bg-white/10 transition-all duration-300 flex-shrink-0">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                    </svg>
                  </a>
                  <a href="https://instagram.com/_sarguru._" target="_blank" rel="noopener noreferrer" className="cursor-target p-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl text-gray-300 hover:text-white hover:bg-white/10 transition-all duration-300 flex-shrink-0">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="https://facebook.com/yourusername" target="_blank" rel="noopener noreferrer" className="cursor-target p-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl text-gray-300 hover:text-white hover:bg-white/10 transition-all duration-300 flex-shrink-0">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                {submitStatus === 'success' ? (
                  <div className="text-center py-6 sm:py-8 w-full">
                    ...
                    <button
                      ...
                      className="cursor-target px-6 sm:px-8 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-medium rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl w-full sm:w-auto"
                    >
                  ...
                  <>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 w-full">
                      ...
                      <button
                        ...
                        className={`cursor-target w-full sm:w-auto px-8 py-3.5 bg-gradient-to-r from-lime-200 to-lime-300 text-gray-900 font-semibold rounded-2xl transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center space-x-2 ${isSubmitting ? 'opacity-75 cursor-not-allowed' : 'hover:scale-[1.02]'}`}
                      >
                        {isSubmitting ? (
                          <>
      ...
      <div className=" my-10 container border border-white/20 rounded-xl p-6 h-[80vh] w-[70vw]  mx-auto ">
