...
const project1 = '/projects/timetable.png';
const project2 = '/projects/resume.png';
const project3 = '/projects/portfolio.png';
const project4 = '/projects/food.png';
const project5 = '/projects/photographer.png';
...
const ProjectCard = React.memo(({ title, desc, img, tags, isDragging = false }) => (
  <div className={`cursor-target relative w-64 h-80 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md  overflow-hidden transition-all duration-300 hover:shadow-[0_40px_90px_rgba(0,0,0,0.55)] p-4 ${isDragging ? 'scale-105 rotate-0 shadow-2xl' : 'hover:scale-105'
    }`}>
